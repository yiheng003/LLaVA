...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # context.
        if len(demo_1_description.split('. ')) > 2:
            demo_1_description = '. '.join(demo_1_description.split('. ')[:1]) + '.'
        if len(demo_2_description.split('. ')) > 2:
            demo_2_description = '. '.join(demo_2_description.split('. ')[:1]) + '.'
