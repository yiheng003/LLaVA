    ...
    def __getitem__(self, index):
        ...
        if self.n_shot == 1:
            ...
            if self.model_config.mm_use_im_start_end:
                demo_instruct_list = [
                    DEFAULT_IM_START_TOKEN + DEFAULT_IMAGE_TOKEN + DEFAULT_IM_END_TOKEN + '\n' + qs + ' please give reasons for your answer.', 
                    DEFAULT_IM_START_TOKEN + DEFAULT_IMAGE_TOKEN + DEFAULT_IM_END_TOKEN + '\n' + qs + ' please give reasons for your answer.',
                    DEFAULT_IM_START_TOKEN + DEFAULT_IMAGE_TOKEN + DEFAULT_IM_END_TOKEN + '\n' + qs + ' please give reasons for your answer.', 
                    DEFAULT_IM_START_TOKEN + DEFAULT_IMAGE_TOKEN + DEFAULT_IM_END_TOKEN + '\n' + qs + ' please give reasons for your answer.'
                ]
        ...
        for idx in range(self.n_shot):
            ...
            # conv.append_message(conv.roles[0], demo_instruct_list[idx])
            # conv.append_message(conv.roles[1], f"Yes. {demo_1_description}\n")   
            # conv.append_message(conv.roles[0], demo_instruct_list[idx])
            # conv.append_message(conv.roles[1], f"No. {demo_2_description}\n")    
            # conv.append_message(conv.roles[0], demo_instruct_list[idx])
            # conv.append_message(conv.roles[1], f"Yes. {demo_3_description}\n")   
            # conv.append_message(conv.roles[0], demo_instruct_list[idx])
            # conv.append_message(conv.roles[1], f"No. {demo_4_description}\n") 
