...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        relation_list = line["p0_caption"]
        caption_list = ["There is "+single_obj_relation+". " for single_occurance in relation_list for single_obj_relation in single_occurance]
        demo_1_caption = "".join(caption_list)
        # demonstration 2.
        demo_2_path = line["p1_image"]
        demo_2_objects = line["p1_objects"]
        caption_list = ["There is "+single_obj_relation+". " for single_occurance in relation_list for single_obj_relation in single_occurance]
        demo_2_caption = "".join(caption_list)
        ...
        conv.append_message(conv.roles[1], demo_2_caption + f" So my answer is yes.\n")
